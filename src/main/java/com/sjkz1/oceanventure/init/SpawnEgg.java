...
public class SpawnEgg  extends SpawnEggItem {
	...
	protected static final List<SpawnEgg> UNADDED_EGGS = new ArrayList<SpawnEgg>();
	private final Lazy<? extends EntityType<?>> entityTypeSupplier;

	public SpawnEgg(final NonNullSupplier<? extends EntityType<?>> entityTypeSupplier, final int primaryColour,
	...
	public SpawnEgg(final RegistryObject<? extends EntityType<?>> entityTypeSupplier, final int primaryColour,
			final int secondaryColour, final Item.Properties properties) {
		super(null, primaryColour, secondaryColour, properties);
		this.entityTypeSupplier = Lazy.of(entityTypeSupplier::get);
		UNADDED_EGGS.add(this);
